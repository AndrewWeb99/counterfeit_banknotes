...
<body>
    ...
    <div class="container">
        <?php require('nav.php'); ?>
        <form action="/blocks/vendor/v_update_reestr_banknote.php" method="post" enctype="multipart/form-data">
            ...
            <div class="facts_sections">
                <div class="facts_two_section">
                    ...
                    <div class="field" style="display: none;">
                        ...
                        <input type="text" name="id_ba" value="<?= $bank['id_ba'] ?>" />
                    </div>
                    <div class="field" style="display: none;">
                        <label for="n">ID img</label>
                        <input type="text" name="material_num_ba" value="<?= $bank['material_num_ba'] ?>" />
                    </div>
                    <div class="field">
                        <label for="ln">Тип</label>
                        <input id="dop_type" type="text" name="" value="<?= $bank['type_ba'] ?>" hidden />
                        <select name="type_ba" id="type_ba" required>
                    ...
                    <div class="field">
                        ...
                        <select name="val_ba" id="val_ba" required>
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="ser_one_ba" id="ser_one_ba" maxlength="2" value="<?= $bank['ser_one_ba'] ?>" />
                    </div>
                    <div class="field">
                        <label for="n">Серия 2</label>
                        <input type="text" name="ser_two_ba" id="ser_two_ba" maxlength="2" value="<?= $bank['ser_two_ba'] ?>" />
                    </div>
                    <div class="field">
                        <label for="ln">Номер</label>
                        <input type="text" name="number_one_ba" id="number_one_ba" maxlength="2" value="<?= $bank['number_one_ba'] ?>" />
                    </div>
                    <div class="field">
                        <label for="ln">Номер 2</label>
                        <input type="text" name="number_two_ba" id="number_two_ba" maxlength="2" value="<?= $bank['number_two_ba'] ?>" />
                    </div>
                    <div class="field">
                        <label for="ln">Год выпуска</label>
                        <input type="date" name="date_ba" id="date_ba" value="<?= $bank['date_ba'] ?>" required/>
                    </div>
                    <div class="field">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="kol_ba" value="<?= $bank['kol_ba'] ?>" required/>
                    </div>
                    <!-- <div class="field">
                ...
                <div class="facts_four_section"> 
                    ...
                    <input type="file" name="material_ba[]" multiple id="gallery-photo-add" >
